...
class VersionsData:
    ...
    def get_upstream_versions(self):
        ...
        for pkg_link in links:
            ...
            if pkg_name2 not in results:
                ...
                results.update([(pkg_name2, pkg_info)])
            else:
    ...
    def get_deb_pair(self, os_pkg_name):
        def sanitize_os_pkg_name(os_pkg_name, str_to_replace):
        ...
        def is_in_deb_data(os_pkg_name, replacement):
...
if __name__ == '__main__':
    ...
    for release in RELEASES:
        ...
        ver_data.update([(release, release_ver_dat.get_versions_data())])

    render_page("index.html", ver_data)
