...
import mxnet as mx
import numpy as np
from mxnet import io, ndarray as nd, recordio
...
class FaceImageIter(io.DataIter):
    ...
    def next_sample(self):
        ...
        # set total batch size, for example, 1800, and maximum size for
        # each people, for example 45
    ...
    # Define functions for data augmentation - brightness, contrast,
    # saturation, color, mirror
