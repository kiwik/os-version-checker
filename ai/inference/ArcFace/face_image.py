...
get_dataset_*dataset-name*(input_dir) loads *dataset-name* dataset
from input_dir
"""
                ...
                if not img.endswith('.jpg.jpg') and img.endswith('.jpg'):
                    ...
                    if os.path.exists(json_file):
                        ...
                        if 'landmarks' in data:
                            ...
                            if ('1' in landmarks and '0' in landmarks
                                    and '2' in landmarks):
                                fimage.landmark = np.zeros((3, 2),
                                                           dtype=np.float32)
...
# Driver function for loading datasets,
# pass name of dataset to load in name argument
